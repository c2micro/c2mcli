...
func UserBeaconPwd(args ...object.Object) (object.Object, error) {
	if len(args) != 1 {
	...
	if err := BackendBeaconPwd(uint32(id.GetValue().(int64))); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendBeaconPwd(id uint32) error {
	cap := defaults.CAP_PWD
	...
	return service.NewTask(id, &operatorv1.NewTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.NewTaskRequest_Pwd{
			Pwd: &commonv1.CapPwd{},
		},
	})
}
