...
func UserBeaconShell(args ...object.Object) (object.Object, error) {
	if len(args) != 2 {
	...
	if err := BackendBeaconShell(uint32(id.GetValue().(int64)), cmd.GetValue().(string)); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendBeaconShell(id uint32, cmd string) error {
	cap := defaults.CAP_SHELL
	...
	return service.NewTask(id, &operatorv1.NewTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.NewTaskRequest_Shell{
