...
func UserBeaconWhoami(args ...object.Object) (object.Object, error) {
	if len(args) != 1 {
	...
	if err := BackendBeaconWhoami(uint32(id.GetValue().(int64))); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendBeaconWhoami(id uint32) error {
	cap := defaults.CAP_WHOAMI
	...
	return service.NewTask(id, &operatorv1.NewTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.NewTaskRequest_Whoami{
