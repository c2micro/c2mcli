...
func UserBeaconExec(args ...object.Object) (object.Object, error) {
	...
	if err := BackendBeaconExec(uint32(id.GetValue().(int64)), cmd.GetValue().(string), arg.GetValue().(string)); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendBeaconExec(id uint32, cmd string, args string) error {
	cap := defaults.CAP_EXEC
	...
	return service.NewTask(id, &operatorv1.NewTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.NewTaskRequest_Exec{
